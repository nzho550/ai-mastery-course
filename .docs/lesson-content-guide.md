...
> **Historical planning document.** The "14 parts · 112 lessons" figure above reflects an earlier stage of authoring — the live course has since grown to 21 parts / 238 lessons. The workshop/reference *pattern* described here still applies; see the repository root `README.md` for current counts.
